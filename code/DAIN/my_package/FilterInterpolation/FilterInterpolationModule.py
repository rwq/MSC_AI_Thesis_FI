...
class AdaptiveWeightInterpolationModule(Module):
    ...
    def forward(self, input1, input2, input3, input4):
        ...
        flow_weight1 = self.calc_weight1.apply(input1,input2,input3 )
        ...
        p1 = self.interpolate1.apply(input1, input3, flow_weight1)
        p1_r,p1_g,p1_b = torch.split(p1,1,dim=1)
        pw1 = self.interpolate1_1.apply(input3, flow_weight1)
        ...
        r1 = pw1
        rw1 = self.interpolate_R1_1.apply(input3)
        ...
        flow_weight2 = self.calc_weight2.apply(input2,input1,input4)
        p2 = self.interpolate2.apply(input2, input4, flow_weight2)
        p2_r,p2_g,p2_b = torch.split(p2,1,dim=1)
        pw2 = self.interpolate2_1.apply(input4, flow_weight2)
        ...
        r2 = pw2
        rw2 = self.interpolate_R2_1.apply(input4)
