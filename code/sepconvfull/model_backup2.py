...
class KernelEstimation(torch.nn.Module):
    ...
    def forward(self, rfields):
        tensorJoin = torch.cat(rfields, 1)
        
        print('shape tj', tensorJoin.shape)
...
class SepConvNet(torch.nn.Module):
    ...
    def forward(self, frames):
        ...
        tensorDot1 = sepconv.FunctionSepconv()(self.modulePad(padded_frames[0]), Vertical1, Horizontal1)
        tensorDot2 = sepconv.FunctionSepconv()(self.modulePad(padded_frames[1]), Vertical2, Horizontal2)
